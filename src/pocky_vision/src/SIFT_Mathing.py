...
import logging
from pocky_vision.srv import pocky_data , pocky_dataResponse
# from pocky_vision.msg import ROI_array_bottom
# from pocky_vision.msg import ROI_bottom
# from pocky_vision.msg import ROI_array_top
# from pocky_vision.msg import ROI_top
...
def pocky_data_sent(req):
    ...
    if look_done == True:
        res.is_done = True
        res.top_box = top_box
        res.top_CenterX = top_CenterX
        res.top_CenterY = top_CenterY
        res.top_Angle = top_Angle
        res.bottom_box = bottom_box
        res.bottom_CenterX = bottom_CenterX
        res.bottom_CenterY = bottom_CenterY
        res.bottom_Angle = bottom_Angle
    else:
        res.is_done = False
    return res
